...
texFile=anzahl-unfaelle-pro-jahr1
...
echo "set key box height 0.75 width -2.0 at graph 0.85, 0.3" >> gnuplot.command
...
echo "plot 'anzahl-unfaelle-pro-jahr.data' using 1:2 with lines title 'Anzahl Unfälle mit Personenschaden' linetype 1 dashtype 1 linewidth 5" >> gnuplot.command
